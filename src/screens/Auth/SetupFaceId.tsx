...
import { ArrowLeft, ScanFace, X } from 'lucide-react-native';
import { NativeStackScreenProps } from '@react-navigation/native-stack';
import { RootStackParamList } from '../../navigation/AppNavigator';
import { Button } from '../../components/ui';
import { styles } from './setupFaceId.styles';

type SetupFaceIdProps = NativeStackScreenProps<RootStackParamList, 'SetupFaceId'>;

const SetupFaceId: React.FC<SetupFaceIdProps> = ({ navigation }) => {
        ...
        <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.subtitle}>
                    Enable Face ID to let you login & proceed{'\n'}your transactions faster.
                </Text>
            </View>
